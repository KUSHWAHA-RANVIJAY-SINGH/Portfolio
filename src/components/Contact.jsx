    ...
    <section id="Contact" className="py-16">
      <div className="container mx-auto px-4 md:px-20">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 max-w-2xl mx-auto font-medium">
            Looking for a MERN Developer? Let's build something amazing together 🚀
          </p>
        </div>
          ...
          <div className="w-full md:w-2/3 bg-gray-50 dark:bg-slate-700 p-8 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <input
                    ...
                    className="w-full p-3 border border-gray-300 dark:border-slate-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white dark:bg-slate-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-slate-400"
                  />
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-orange-500 text-white font-bold py-3 px-8 rounded-lg hover:bg-orange-600 transition-colors duration-300"
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="w-full md:w-1/3">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="bg-orange-100 dark:bg-orange-900/40 p-3 rounded-full text-orange-500 dark:text-orange-400">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:ranvijaysingh1588@gmail.com"
              ...
              {/* WhatsApp Button */}
              <a
                href="https://wa.me/919135173003"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 shadow-md w-full mt-2"
              >
                <FaWhatsapp size={22} />
                Chat on WhatsApp
              </a>
